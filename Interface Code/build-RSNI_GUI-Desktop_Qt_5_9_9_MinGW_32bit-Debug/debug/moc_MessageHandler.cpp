...
#include "../../RSNI_GUI/MessageHandler.h"
...
QT_MOC_LITERAL(1, 15, 19), // "newMessageAvailable"
QT_MOC_LITERAL(2, 35, 0), // ""
QT_MOC_LITERAL(3, 36, 9), // "RxMessage"
QT_MOC_LITERAL(4, 46, 3), // "msg"
QT_MOC_LITERAL(5, 50, 13), // "handleTCPData"
QT_MOC_LITERAL(6, 64, 7) // "newData"

    },
    "MessageHandler\0newMessageAvailable\0\0"
    "RxMessage\0msg\0handleTCPData\0newData"
};
...
void MessageHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->newMessageAvailable((*reinterpret_cast< RxMessage(*)>(_a[1]))); break;
        case 1: _t->handleTCPData((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (MessageHandler::*_t)(RxMessage );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MessageHandler::newMessageAvailable)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MessageHandler::newMessageAvailable(RxMessage _t1)
{
