...
#include "../../RSNI_GUI/TablePushButton.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_TablePushButton_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_TablePushButton_t qt_meta_stringdata_TablePushButton = {
    {
QT_MOC_LITERAL(0, 0, 15), // "TablePushButton"
QT_MOC_LITERAL(1, 16, 14), // "buttonReleased"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 8), // "sensorID"
QT_MOC_LITERAL(4, 41, 21) // "internalButtonHandler"

    },
    "TablePushButton\0buttonReleased\0\0"
    "sensorID\0internalButtonHandler"
};
...
void TablePushButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->buttonReleased((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->internalButtonHandler(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TablePushButton::buttonReleased)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject TablePushButton::staticMetaObject = {
    { &QPushButton::staticMetaObject, qt_meta_stringdata_TablePushButton.data,
      qt_meta_data_TablePushButton,  qt_static_metacall, nullptr, nullptr}
};
...
void *TablePushButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TablePushButton.stringdata0))
...
// SIGNAL 0
void TablePushButton::buttonReleased(int _t1)
{
